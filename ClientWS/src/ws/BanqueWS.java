 ...
 * 
 */
@WebServiceClient(name = "BanqueWS", targetNamespace = "http://ws/", wsdlLocation = "http://localhost:8080/BanqueServise/?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8080/BanqueServise/?wsdl");
     ...
     * 
     * @return
     *     returns BanqueServise
     */
    @WebEndpoint(name = "BanqueServisePort")
    public BanqueServise getBanqueServisePort() {
        return super.getPort(new QName("http://ws/", "BanqueServisePort"), BanqueServise.class);
    }
     ...
     */
    @WebEndpoint(name = "BanqueServisePort")
    public BanqueServise getBanqueServisePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws/", "BanqueServisePort"), BanqueServise.class, features);
    }

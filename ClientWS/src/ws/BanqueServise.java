 ...
 * 
 */
@WebService(name = "BanqueServise", targetNamespace = "http://ws/")
@XmlSeeAlso({
    ObjectFactory.class
})
public interface BanqueServise {
    ...
    @Action(input = "http://ws/BanqueServise/ConversionEuroToDHRequest", output = "http://ws/BanqueServise/ConversionEuroToDHResponse")
    ...
    @Action(input = "http://ws/BanqueServise/getCompteRequest", output = "http://ws/BanqueServise/getCompteResponse")
    ...
    @Action(input = "http://ws/BanqueServise/listeComptesRequest", output = "http://ws/BanqueServise/listeComptesResponse")
